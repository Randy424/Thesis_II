...
x_train = x_train.reshape(2160, 2, 1)
x_test = x_test.reshape(720, 2, 1)
...
model = Sequential()
model.add(Reshape((4320, 1), input_shape=((2160, 2, 1))))
model.add(Conv1D(100, kernel_size=(2), activation='relu', input_shape = (None, 1)))
