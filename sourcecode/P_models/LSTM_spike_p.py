...
perform_graph = Graph(None, history.history['acc'], None, history.history['val_acc'],
 'LSTM model accuracy (spike)', 'epoch', 'accuracy', ['train', 'test'])
perform_graph.build_double_line_graph()

loss_graph = Graph(None, history.history['loss'], None, history.history['val_loss'],
 'LSTM model loss (spike)', 'epoch', 'loss', ['train', 'test'])
loss_graph.build_double_line_graph()
...
plt.title('LSTM model accuracy (spike)')
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
plt.title('LSTM model loss (spike)')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.show()
