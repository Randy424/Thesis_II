...
plt.title('RNN model accuracy (spike)')
plt.ylabel('accuracy')
plt.xlabel('epoch')
...
plt.title('RNN model loss (spike)')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.show()
