...
my_file = os.path.join(THIS_FOLDER, '../data/suspicious_data/*.nc') 
...
x_train = x_train.reshape(11818, 1, 1)
x_test = x_test.reshape(3940, 1, 1)
y_train = y_train.reshape(11818,1,2)
